...
def take_screenshot(org_login, request):
    ...
    screenshots_dir = r"D:\HPB_Testcase\screenshots/department"
...
def test_edit_department(org_login, take_screenshot):
    ...
    driver.find_element(By.XPATH, "//div[@class='content-body']//div[2]//label[1]//input[1]").send_keys(last_name)
    driver.find_element(By.XPATH, "//div[@class='form-wrap-nav-btn']//div[@class='next-btn'][normalize-space()='Next']").click()
    time.sleep(2)
    driver.find_element(By.XPATH, "//*[@id='add-admin']/div/div/div/div/app-edit-department-admin/div[1]/div[2]/div[2]/form/div[2]/div/app-assign-org-facility-dept/div[2]/div").click()
    time.sleep(2)
